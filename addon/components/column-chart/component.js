...
export default BaseChartComponent.extend({
    ...
    addDataValues(bars = []) {
        ...
        const allNegativeValues = this.get('yAxis').allNegative;
        ...
        for (let i = 0; i < bars.length; i++) {
            ...
            gLabels.append('text')
                ...
                .attr('y', Math.max(12, allNegativeValues ? maxLabelYHeight + 12 : maxLabelY - 2))
        ...
        if (b) {
            ...
            if (!(maxIdx === minIdx)) {
                gLabels.append('text')
                    ...
                    .attr('x', +b.getAttribute('x') + (b.getAttribute('width') / 2))
                    .attr('y', allNegativeValues ? maxLabelYHeight + 24 : maxLabelY - 12);
            }
        }
        b = bars[minIdx];
